...
export const fakeDayDataNEW = [
    {
        user_name: 'Dejan D',
        id: uuidv4(),
        events: [
            { event_name: 'Meeting', offset: 0, colspan: 6, id: uuidv4() },
            { event_name: 'Meeting', offset: 2, colspan: 8, id: uuidv4() },
        ]
    },
    {
        user_name: 'Jovan K',
    ...
    },
    {
        ...
        id: uuidv4(),
        events: [
            { event_name: 'Meeting', from: 8, to: 9, offset: 1, colspan: 1, id: uuidv4() },
            { event_name: 'Training', from: 11, to: 12, offset: 2, colspan: 1, id: uuidv4() }
        ]
    },
    {
        user_name: 'Vukasin D.',
